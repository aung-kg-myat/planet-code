        ...
        >
          <div class="flex items-center justify-center w-full h-full">
            <div>
              ...
              <h1
                class="text-center font-bold section-title px-8 font-carterOne"
              >
              ...
              >
                ...
                high-performance website, a robust business management system,
                or a custom software solution tailored to your unique
                requirements, we have the expertise to bring your vision to
                life. <br /><br />
                At
                <span class="font-carterOne"
                  >PLANET <span class="!text-[#755dcd]">CODE</span></span
                ...
                excellence to deliver transformative software solutions that
                help businesses thrive in the digital era. 🚀 Let’s innovate,
                grow, and redefine possibilities together with
                <span class="font-carterOne"
                  >PLANET <span class="!text-[#755dcd]">CODE</span></span
                >!
              </p></div
